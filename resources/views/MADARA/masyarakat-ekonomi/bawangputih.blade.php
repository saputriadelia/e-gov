...
<head>
    ...
    <title>Harga Bawang Putih IR.64 - Kota Malang</title>
    ...
    <style>
        ...
        .navbar-nav .nav-link {
            ...
            /* mengurangi padding pada tombol kembali */
            font-size: 0.9rem;
        }
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2 class="text-center">Harga Bawang Putih IR.64</h2>
    ...
    <script>
        ...
        function updateChart(newData) {
            ...
            newData.forEach(yearData => {
                ...
                priceChart.data.datasets.push({
                    label: `Harga Beras IR.64 (${yearData.year})`,
        ...
        // Memperbarui chart dengan contoh data
